...
exports.paymentRequests = async (req: Request, res: Response) => {
  ...
  request(
    ...
    (
      error: any,
      response: { statusCode: any; headers: any; body?: any },
      body: any
    ) => {
      ...
      if (response.statusCode == 201) {
        ...
        request(
          opt,
          (err: any, resp: { body: { [x: string]: any } }, bod: any) => {
            logResult(err, resp);
            if (!response) {
              res.status(500).send(error);
              return;
...
exports.paymentRequestsId = async (req: Request, res: Response) => {
  ...
  request(
    ...
    (
      error: any,
      response: { statusCode: number; body: { [x: string]: any } },
      body: any
    ) => {
      logResult(error, response);
...
exports.refunds = async (req: Request, res: Response) => {
  ...
  request(
    ...
    (
      error: any,
      response: { statusCode: number; headers: { [x: string]: any } },
      body: any
    ) => {
      logResult(error, response);
